...
```{r}
mdists <- read.csv("../isoforms/APCanalysis/mdist_sorted.csv", header = FALSE)
...
```
none of the groups are significantly different from another
...
```{r}
weights <- read.csv("/home/ismael/Code/isoforms/results_optiso2.csv", skip=1)
